...
const locations = [
  {
    ...
    images: [
      ...
      "https://images.unsplash.com/photo-1518098268026-4e89f1a2cd8e?q=80&w=2574&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ],
  },
  {
    name: "Location 2",
...
export default function LocationGrid() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {locations.map((loc, i) => (
        <LocationTile key={i} name={loc.name} images={loc.images} />
      ))}
    </div>
  );
}
